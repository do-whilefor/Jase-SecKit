...
- Reported focus: GRT-01-004 WP1/2: Ground Truth RCEs via Crafted Config Files
...
- Reported focus: CSV Export Allows Arbitrary Command Execution in CSV File
- Transferable test ideas:
...
- Reported focus: 11 Path traversal through chart's dependency Data Validation
- Transferable test ideas:
...
- Reported focus: Remote Code Execution via Conversation-/Nick-Name
- Transferable test ideas:
